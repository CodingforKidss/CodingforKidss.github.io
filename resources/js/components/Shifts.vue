    ...
    export default {
        ...
        data() {
            ...
            return {
                page     : {
                    title      : 'Shifts',
                    subTitle   : 'List and manage Shift',
                    vuexKey    : 'shifts',
                    loading    : false,
                    searching  : false,
                    searchText : '',
                    ...
                    print      : {
                        ...
                        class     : '',
                        headers   : ['Id', 'Shift Name', 'Day', 'Time From', 'Time To', 'Duration', 'Break From', 'Break To', 'Break Duration', 'Status'],
                        fields    : ['id', 'name', 'day', 'time_from', 'time_to', 'duration', 'break_time_from', 'break_time_to', 'duration_break', 'active'],
                    },
                    headers    : [
                        {
                            title   : 'Id',
                ...
                modalEdit: {
                    ...
                    dbInsert    : {
                        ...
                        actionType        : 'edit_shift',
                        storeInEdits      : true,
                        validations       : {
                            'id'             : 'required|min:1|max:14',
                            'name'           : 'required|min:1|max:255',
                            'day_id'         : 'max:32',
                            'time_from'      : 'required|min:1|max:32',
                            'time_to'        : 'required|min:1|max:32',
                            'duration'       : 'max:16',
                            'break_time_from': 'max:32',
                            'break_time_to'  : 'max:32',
                            'duration_break' : 'max:16',
                ...
                if (data && data['data'] && data['data'].length > 0) {
                    data['data'].forEach((d, i) => {
                        data['data'][i]['TableViewData'] = {
                            ...
                            'duration_break' : d['duration_break'] ? d['duration_break'] : '-',
            ...
            generateModalView(modalData) {
                ...
                let tableTRData = [
                    ...
                    [
                        ...
                        {
                            data : modalData.break_time_from ? this.timeFormat(modalData.break_time_from, 'hh:mm A') : '-',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : modalData.break_time_to ? this.timeFormat(modalData.break_time_to, 'hh:mm A') : '-',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : modalData.duration_break ? modalData.duration_break : '-',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',

                                ...
                                <table class = "table table-striped table-hover">
                                    ...
                                    <template v-for = "(item, index) of page.headers">
                                        <th :class = "item.class"
                                                ...
                                                @click.prevent = "sortTableData(item, dbQuery, page.vuexKey)"> {{item.title}}
                                            <i class = "fas"
                                    ...
                                    <tr :key = "index" class = "" v-for = "(item, index) in paginated('items')" v-if = "dataTable && dataTable['data'] && dataTable['data'].length > 0">
                                        ...
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['course']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['enrolment']['name']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['enrol_date']}}</td>
    ...
    export default {
        ...
        data() {
            ...
            return {
                page     : {
                    title      : 'Enrolments',
                    subTitle   : 'List and manage Enrolment',
                    vuexKey    : 'enrolments',
                    loading    : false,
                    searching  : false,
                    searchText : '',
                    ...
                    print      : {
                        ...
                        class     : '',
                        headers   : ['Id', 'Enrolment Name', 'Category', 'Status'],
                    ...
                    headers    : [
                        ...
                        {
                            title   : 'Course',
                            relation: 'course_id', // false or 'string'
                            field   : 'name',
                            operator: 'like',
                            sortType: 'js', // js, jsText or db
                            click   : '',
                        ...
                        {
                            title   : 'Student',
                            relation: 'user_id', // false or 'string'
                            field   : 'name',
                            operator: 'like',
                            sortType: 'js', // js, jsText or db
                            click   : '',
                ...
                modalAdd : {
                    ...
                    inputs      : [
                        {
                            ...
                            validation     : {
                                active    : true,
                                show      : true,
                                label     : 'Course', // Validation Error Label
                                class     : 'error',
                                style     : '',
                                validators: {
                                    required: {
                        ...
                        },
                        {
                            ...
                            validation     : {
                                active    : true,
                                show      : true,
                                label     : 'Student', // Validation Error Label
                                class     : 'error',
                                style     : '',
                                validators: {
                                    required: {
                        ...
                        },
                        {
                            ...
                            disabled       : false,
                            value          : null,
                            formControlName: 'enrol_date',
                            validation     : {
                                active    : false,
                                show      : false,
                                label     : 'Enrolment Date', // Validation Error Label
                                class     : 'error',
                                style     : '',
                                validators: {
                                    required: {
                                        message: 'Enrolment Date is Required'
                                    },
                                },
                            },
                        },
                    ...
                    dbInsert    : {
                        ...
                        actionType        : 'add_category_item',
                        validations       : {
                            'id'           : 'required|min:1|max:14',
                            'course_id'    : 'required|min:1|max:32',
                            'user_id'      : 'required|min:1|max:32',
                            'enrol_date'   : 'required|min:1|max:32',
                            'description'  : 'max:512',
                            'api_ver'      : 'max:8',
                            'app_ver'      : 'max:8',
                            'app_build_ver': 'max:8',
                ...
                dbDestroy: {
                    ...
                    actionType    : 'delete_category_item',
                    storeInDeletes: true,
                    validations   : {
        ...
        created() {
            ...
            // this.onLoadPageData(this.testAPI, null, this.page.vuexKey, 'loading', false, this.modalEdit.formKey);
                ...
                if (data && data['data'] && data['data'].length > 0) {
                    data['data'].forEach((d, i) => {
                        data['data'][i]['TableViewData'] = {
                            'id'        : d['id'],
                            'enrol_date': d['enrol_date'],
                            'course'    : d['course'] ? d['course']['name'] : '',  // use relation name a key for relations
                            'enrolment' : d['enrolment'] ? d['enrolment'] : '',  // use relation name a key for relations
            ...
            generateModalView(modalData) {
                ...
                let tableTRData = [
                    ...
                    [
                        ...
                        {
                            data : modalData.category_item_no,
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : modalData.category ? modalData.category.name : '-',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',

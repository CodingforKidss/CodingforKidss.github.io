                    ...
                    <div class = "row ml-1 mr-1">
                        <div class = "col-md-8">
                            <div class = "card-header">
                                <h4 class = "card-title" v-if = "page.viewType && page.viewType === 'add'">Add Parent</h4>
                                <h4 class = "card-title"
                                        v-if = "page.viewType && page.viewType === 'edit' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] !== 'Parent'">
                                    Edit Parent</h4>
                                <h4 class = "card-title"
                                        v-if = "page.viewType && page.viewType === 'edit' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] === 'Parent'">
                                    Edit Profile</h4>
                                <h4 class = "card-title"
                                        v-if = "page.viewType && page.viewType === 'view' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] !== 'Parent'">
                                    Parent Details</h4>
                                <h4 class = "card-title"
                                        v-if = "page.viewType && page.viewType === 'view' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] === 'Parent'">
                                    My Profile</h4>
                                <p class = "card-category" v-if = "page.viewType && page.viewType === 'add'">Add New Parent</p>
                                <p class = "card-category"
                                        v-if = "page.viewType && page.viewType === 'edit' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] !== 'Parent'">
                                    Edit Parent Information</p>
                                <p class = "card-category"
                                        v-if = "page.viewType && page.viewType === 'edit' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] === 'Parent'">
                                    Edit Profile Information</p>
                                <p class = "card-category"
                                        v-if = "page.viewType && page.viewType === 'view' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] !== 'Parent'">
                                    View Details of an Parent</p>
                                <p class = "card-category"
                                        v-if = "page.viewType && page.viewType === 'view' && page.user && page.user['role'] && page.user['role']['name'] && page.user['role']['name'] === 'Parent'">
                            ...
                            <div class = "card">
                                <div class = "card-body" style = "padding: 0px 32px 10px 32px;">
                                    <div class = "table-responsive">
                                        ...
                                        <div class = "row">
                                            <div class = "col">
                                                <div class = "cmv-label">Parent Name</div>
                            ...
                            <div class = "card">
                                <div class = "card-body" style = "padding: 0px 32px 10px 32px;">
                                    <div class = "table-responsive">
                                        ...
                                        <div class = "row">
                                            <div class = "col">
                                                <div class = "cmv-label">Parent Number</div>
                                            ...
                                            <div class = "form-row">
                                                <div class = "col">
                                                    <div :class = "[$v.modalAdd.form && $v.modalAdd.form[modalAdd.inputs.name.formControlName] && $v.modalAdd.form[modalAdd.inputs.name.formControlName].$error ? 'form-group--error' : '', 'form-group']">
                                                        <label :for = "modalAdd.inputs.name.formControlName">Parent Name</label>
                                                        <input class = "form-control"
                                            ...
                                            <div class = "form-row">
                                                <div class = "col">
                                                    <div :class = "[$v.modalAdd.form && $v.modalAdd.form[modalAdd.inputs.employee_no.formControlName] && $v.modalAdd.form[modalAdd.inputs.employee_no.formControlName].$error ? 'form-group--error' : '', 'form-group']">
                                                        <label :for = "modalAdd.inputs.employee_no.formControlName">Parent Number</label>
                                                        <input class = "form-control"
                                            ...
                                            <div class = "form-row">
                                                <div class = "col">
                                                    <div :class = "[$v.modalEdit.form && $v.modalEdit.form[modalEdit.inputs.name.formControlName] && $v.modalEdit.form[modalEdit.inputs.name.formControlName].$error ? 'form-group--error' : '', 'form-group']">
                                                        <label :for = "modalEdit.inputs.name.formControlName">Parent Name</label>
                                                        <input class = "form-control"
                                                                :id = "modalEdit.inputs.name.formControlName"
                                                                :name = "modalEdit.inputs.name.formControlName"
                                                                placeholder = ""
                                                                :readonly = "page.user['role']['name'] === 'Parent'"
                                                ...
                                                <div class = "col-4">
                                                    <div :class = "[$v.modalEdit.form && $v.modalEdit.form[modalEdit.inputs.gender.formControlName] && $v.modalEdit.form[modalEdit.inputs.gender.formControlName].$error ? 'form-group--error' : '', 'form-group']">
                                                        ...
                                                        <multiselect :allow-empty = "true"
                                                                ...
                                                                placeholder = ""
                                                                :disabled = "page.user['role']['name'] === 'Parent'"
                                                                :preselectFirst = "false"
                                                                :searchable = "true"
                                                                :show-labels = "false"
                                                                label = "name"
                                            ...
                                            <div class = "form-row">
                                                <div class = "col">
                                                    <div :class = "[$v.modalEdit.form && $v.modalEdit.form[modalEdit.inputs.employee_no.formControlName] && $v.modalEdit.form[modalEdit.inputs.employee_no.formControlName].$error ? 'form-group--error' : '', 'form-group']">
                                                        <label :for = "modalEdit.inputs.employee_no.formControlName">Parent Number</label>
                                                        <input class = "form-control"
        ...
        data() {
            ...
            return {
                page     : {
                    ...
                    subTitle   : 'View Details of an Parent',
                    vuexKey    : 'profile',
                    loading    : false,
                    searching  : false,
                    searchText : '',

                            ...
                            <paginate :list = "dataTable['data']" :per = "perPage" name = "items" ref = "paginator" tag = "div">
                                <table class = "table table-striped table-hover">
                                    ...
                                    <tr :key = "index" class = "" v-for = "(item, index) in paginated('items')" v-if = "dataTable && dataTable['data'] && dataTable['data'].length > 0">
                                        ...
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['department']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['designation']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['phone']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['pay_rate']}}</td>
                                        <td @click.prevent = "viewModal(item)">
    ...
    export default {
        ...
        data() {
            ...
            return {
                page     : {
                    title      : 'Employees',
                    subTitle   : 'List and manage Employee',
                    vuexKey    : 'employees',
                    loading    : false,
                    searching  : false,
                    searchText : '',
                    ...
                    print      : {
                        ...
                        class     : '',
                        headers   : ['Id', 'Emp Number', 'Name', 'Shift', 'Department', 'Designation', 'Phone', 'Salary', 'Status'],
                        fields    : ['id', 'employee_no', 'name', 'shift', 'department', 'designation', 'phone', 'pay_rate', 'active'],
                    },
                    headers    : [
                        {
                            title   : 'Id',
                        ...
                        {
                            title   : 'Department',
                            relation: 'department', // false or 'string'
                            field   : 'name',
                            operator: 'like',
                            sortType: 'js', // js, jsText or db
                            click   : '',
                        ...
                        {
                            title   : 'Designation',
                            relation: 'designation', // false or 'string'
                            field   : 'name',
                            operator: 'like',
                            sortType: 'js', // js, jsText or db
                            click   : '',
                ...
                if (data && data['data'] && data['data'].length > 0) {
                    data['data'].forEach((d, i) => {
                        data['data'][i]['TableViewData'] = {
                            ...
                            'department' : d['department'] ? d['department']['name'] : '',  // use relation name a key for relations
                            'designation': d['designation'] ? d['designation']['name'] : '',  // use relation name a key for relations
                            'address'    : d['address'],
                            'phone'      : d['phone'],
                            'pay_rate'   : d['pay_rate'] ? (this.twoDecimalPlace(d['pay_rate']) + (d['pay_rate_unit_type'] ? ('/' + d['pay_rate_unit_type']['name']) : '')) : '',  // use relation name a key for relations
            ...
            generateModalView(modalData) {
                ...
                let tableTRData = [
                    ...
                    [
                        ...
                        {
                            data : modalData.shift ? modalData.shift.name : '',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : modalData.department ? modalData.department.name : '',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : this.dateFormat(modalData.joining_date, 'Do MMM, YYYY'),
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : modalData.function ? modalData.function.name : '',
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
                    ...
                    [
                        ...
                        {
                            data : 'BDT ' + this.twoDecimalPlace(modalData.pay_rate) + '/' + (modalData.pay_rate_unit_type ? modalData.pay_rate_unit_type.name : ''),
                            class: '',
                            style: '',
                            scope: '',
                            span : '',

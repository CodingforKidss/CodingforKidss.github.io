                                ...
                                <table class = "table table-striped table-hover">
                                    ...
                                    <tr :key = "index" class = "" v-for = "(item, index) in paginated('items')" v-if = "dataTable && dataTable['data'] && dataTable['data'].length > 0">
                                        ...
                                        <td @click.prevent = "viewModal(item)">
                                            {{item['TableViewData']['course_no']}}
                                        </td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['name']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['price']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['duration']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['start_date']}}</td>
                                        <td @click.prevent = "viewModal(item)">{{item['TableViewData']['start_time']}}</td>
                                        <td @click.prevent = "viewModal(item)">
    ...
    export default {
        ...
        data() {
            ...
            return {
                page     : {
                    title      : 'Course',
                    subTitle   : 'List and manage Course',
                    vuexKey    : 'courses',
                    loading    : false,
                    searching  : false,
                    searchText : '',
                    ...
                    print      : {
                        ...
                        class     : '',
                        headers   : ['Id', 'Course Number', 'Course Name', 'Total Enrolement', 'Status'],
                        fields    : ['id', 'course_no', 'name', 'course_enrolments_count', 'active'],
                    },
                    headers    : [
                        {
                            title   : 'Id',
                ...
                modalAdd : {
                    ...
                    inputs      : [
                        ...
                        },
                        {
                            ...
                            validation     : {
                                active    : false,
                                show      : false,
                                label     : 'Start Date', // Validation Error Label
                                class     : 'error',
                                style     : '',
                                validators: {
                                    required: {
                        ...
                        },
                        {
                            ...
                            validation     : {
                                active    : false,
                                show      : false,
                                label     : 'Start At', // Validation Error Label
                                class     : 'error',
                                style     : '',
                                validators: {
                                    required: {
                    ...
                    dbInsert    : {
                        ...
                        validations       : {
                            ...
                            'course_no'    : 'required|min:1|max:32',
                        ...
                        unique            : {
                            'id'       : '|unique:courses,id,',
                            'course_no': '|unique:courses,course_no,',
                        },
                    },
                },
                modalEdit: {
            ...
            generateModalView(modalData) {
                ...
                let tableTRData = [
                    ...
                    [
                        ...
                        {
                            data : modalData.course_enrolments_count,
                            class: '',
                            style: '',
                            scope: '',
                            span : '',
